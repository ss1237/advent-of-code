...
public class AOC2022D23P1 {
	static String filename = "aoc";
	static int[][][] d = new int[4][2][3];
	static int numCycles = 10;
	...
	public static void main(String[] args) throws IOException {
		...
		int numElves = 0, minR = grid.length, maxR = -1, minC = grid[0].length, maxC = -1;
		...
		out.println((maxR - minR + 1) * (maxC - minC + 1) - numElves);
